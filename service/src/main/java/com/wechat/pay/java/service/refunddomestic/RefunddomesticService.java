...
public class RefunddomesticService {
  ...
  public static class Builder {
    ...
    public RefunddomesticService build() {
      return new RefunddomesticService(httpClient, hostName, encryptor);
    }
  }
   ...
   * @throws MalformedMessageException 服务返回成功，content-type不为application/json、解析返回体失败。
   */
  public Refund createAbnormalRefund(CreateAbnormalRefundRequest request) {
    String requestPath =
        "https://api.mch.weixin.qq.com/v3/refund/domestic/refunds/{refund_id}/apply-abnormal-refund";
    // 加密敏感信息

    CreateAbnormalRefundRequest realRequest = request.cloneWithCipher(encryptor::encrypt);
    // 添加 path param
    requestPath =
