...
/** PalmMetroSceneInfo */
public class PalmMetroSceneInfo {
  ...
  /** 刷掌扣款凭证 说明：由刷掌终端设备生成的刷掌扣款凭证，扣费时会对刷掌扣款凭证进行校验 */
  @SerializedName("deduct_credential")
  private String deductCredential;
  ...
  public String getDeductCredential() {
    return deductCredential;
  }

  public void setDeductCredential(String deductCredential) {
    this.deductCredential = deductCredential;
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PalmMetroSceneInfo {\n");
    ...
    sb.append("    deductCredential: ").append(toIndentedString(deductCredential)).append("\n");
    sb.append("}");
    return sb.toString();
  }
}
