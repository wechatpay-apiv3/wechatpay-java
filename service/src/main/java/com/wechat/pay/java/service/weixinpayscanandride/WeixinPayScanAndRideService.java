...
public class WeixinPayScanAndRideService {
   ...
   *
   * @param request 请求参数
   * @return PalmPayTransaction
   * @throws HttpException 发送HTTP请求失败。例如构建请求参数失败、发送请求失败、I/O错误等。包含请求信息。
   * @throws ValidationException 发送HTTP请求成功，验证微信支付返回签名失败。
   * @throws ServiceException 发送HTTP请求成功，服务返回异常。例如返回状态码小于200或大于等于300。
   * @throws MalformedMessageException 服务返回成功，content-type不为application/json、解析返回体失败。
   */
  public PalmPayTransaction createPalmPayTransaction(CreatePalmPayTransactionRequest request) {
    String requestPath = "https://api.mch.weixin.qq.com/v3/transit-palm-pay/transactions";
    CreatePalmPayTransactionRequest realRequest = request;
    ...
    HttpRequest httpRequest =
        new HttpRequest.Builder()
            ...
            .build();
    HttpResponse<PalmPayTransaction> httpResponse =
        httpClient.execute(httpRequest, PalmPayTransaction.class);
   ...
   * @throws MalformedMessageException 服务返回成功，content-type不为application/json、解析返回体失败。
   */
  public PalmPayTransaction queryPalmPayTransaction(QueryPalmPayTransactionRequest request) {
    String requestPath =
        "https://api.mch.weixin.qq.com/v3/transit-palm-pay/transactions/{out_trade_no}";

    QueryPalmPayTransactionRequest realRequest = request;
    // 添加 path param
    requestPath =
