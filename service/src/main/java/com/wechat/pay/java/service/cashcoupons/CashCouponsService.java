...
public class CashCouponsService {
   ...
   *
   * @param request 请求参数
   * @return PlatformFavorStockEntity
   * @throws HttpException 发送HTTP请求失败。例如构建请求参数失败、发送请求失败、I/O错误等。包含请求信息。
   * @throws ValidationException 发送HTTP请求成功，验证微信支付返回签名失败。
   * @throws ServiceException 发送HTTP请求成功，服务返回异常。例如返回状态码小于200或大于等于300。
   * @throws MalformedMessageException 服务返回成功，content-type不为application/json、解析返回体失败。
   */
  public PlatformFavorStockEntity createPlatformFavor(PlatformFavorCreateRequest request) {
    String requestPath = "https://api.mch.weixin.qq.com/v3/marketing/favor/platform-favor";
    PlatformFavorCreateRequest realRequest = request;
    if (this.hostName != null) {
      requestPath = requestPath.replaceFirst(HostName.API.getValue(), hostName.getValue());
    }
    HttpHeaders headers = new HttpHeaders();
    ...
    HttpRequest httpRequest =
        new HttpRequest.Builder()
            ...
            .body(createRequestBody(realRequest))
            .build();
    HttpResponse<PlatformFavorStockEntity> httpResponse =
        httpClient.execute(httpRequest, PlatformFavorStockEntity.class);
    return httpResponse.getServiceResponse();
  }
  /**
   * 查询立减金批次信息
   ...
   * @throws MalformedMessageException 服务返回成功，content-type不为application/json、解析返回体失败。
   */
  public PlatformFavorStockEntity getPlatformFavor(GetPlatformFavorRequest request) {
    String requestPath =
        "https://api.mch.weixin.qq.com/v3/marketing/favor/platform-favor/{stock_id}";

    GetPlatformFavorRequest realRequest = request;
    // 添加 path param
   ...
   *
   * @param request 请求参数
   * @return CreateNocashSingleitemStockResponse
   * @throws HttpException 发送HTTP请求失败。例如构建请求参数失败、发送请求失败、I/O错误等。包含请求信息。
   * @throws ValidationException 发送HTTP请求成功，验证微信支付返回签名失败。
   * @throws ServiceException 发送HTTP请求成功，服务返回异常。例如返回状态码小于200或大于等于300。
   * @throws MalformedMessageException 服务返回成功，content-type不为application/json、解析返回体失败。
   */
  public CreateNocashSingleitemStockResponse createNocashSingleitemStock(
      CreateNocashSingleitemStockRequest request) {
    String requestPath =
        "https://api.mch.weixin.qq.com/v3/marketing/favor/nocash-singleitem-stocks";
    CreateNocashSingleitemStockRequest realRequest = request;
    if (this.hostName != null) {
      requestPath = requestPath.replaceFirst(HostName.API.getValue(), hostName.getValue());
    }
    HttpHeaders headers = new HttpHeaders();
    ...
    HttpRequest httpRequest =
        new HttpRequest.Builder()
            ...
            .body(createRequestBody(realRequest))
            .build();
    HttpResponse<CreateNocashSingleitemStockResponse> httpResponse =
        httpClient.execute(httpRequest, CreateNocashSingleitemStockResponse.class);
    return httpResponse.getServiceResponse();
  }
  /**
   * 创建无资金流全场批次
   *
   * @param request 请求参数
   * @return CreateNocashStockResponse
   * @throws HttpException 发送HTTP请求失败。例如构建请求参数失败、发送请求失败、I/O错误等。包含请求信息。
   * @throws ValidationException 发送HTTP请求成功，验证微信支付返回签名失败。
   * @throws ServiceException 发送HTTP请求成功，服务返回异常。例如返回状态码小于200或大于等于300。
   * @throws MalformedMessageException 服务返回成功，content-type不为application/json、解析返回体失败。
   */
  public CreateNocashStockResponse createNocashStock(CreateNocashStockRequest request) {
    String requestPath = "https://api.mch.weixin.qq.com/v3/marketing/favor/nocash-stocks";
    CreateNocashStockRequest realRequest = request;
    if (this.hostName != null) {
      requestPath = requestPath.replaceFirst(HostName.API.getValue(), hostName.getValue());
    }
    HttpHeaders headers = new HttpHeaders();
    ...
    HttpRequest httpRequest =
        new HttpRequest.Builder()
            ...
            .body(createRequestBody(realRequest))
            .build();
    HttpResponse<CreateNocashStockResponse> httpResponse =
        httpClient.execute(httpRequest, CreateNocashStockResponse.class);
    return httpResponse.getServiceResponse();
  }
  /**
   * 查询代金券可用商户
   ...
   *
   * @param request 请求参数
   * @return ModifyAvailableMerchantResponse
   * @throws HttpException 发送HTTP请求失败。例如构建请求参数失败、发送请求失败、I/O错误等。包含请求信息。
   * @throws ValidationException 发送HTTP请求成功，验证微信支付返回签名失败。
   * @throws ServiceException 发送HTTP请求成功，服务返回异常。例如返回状态码小于200或大于等于300。
   * @throws MalformedMessageException 服务返回成功，content-type不为application/json、解析返回体失败。
   */
  public ModifyAvailableMerchantResponse modifyAvailableMerchants(
      ModifyAvailableMerchantsRequest request) {
    String requestPath =
        "https://api.mch.weixin.qq.com/v3/marketing/favor/stocks/{stock_id}/modify-merchants";

    ModifyAvailableMerchantsRequest realRequest = request;
    // 添加 path param
    requestPath = requestPath.replace("{" + "stock_id" + "}", urlEncode(realRequest.getStockId()));
    ...
    HttpRequest httpRequest =
        new HttpRequest.Builder()
            ...
            .body(createRequestBody(realRequest))
            .build();
    HttpResponse<ModifyAvailableMerchantResponse> httpResponse =
        httpClient.execute(httpRequest, ModifyAvailableMerchantResponse.class);
    return httpResponse.getServiceResponse();
  }
  /**
   * 修改可核销商品编码
   *
   * @param request 请求参数
   * @return ModifyAvailableSingleitemResponse
   * @throws HttpException 发送HTTP请求失败。例如构建请求参数失败、发送请求失败、I/O错误等。包含请求信息。
   * @throws ValidationException 发送HTTP请求成功，验证微信支付返回签名失败。
   * @throws ServiceException 发送HTTP请求成功，服务返回异常。例如返回状态码小于200或大于等于300。
   * @throws MalformedMessageException 服务返回成功，content-type不为application/json、解析返回体失败。
   */
  public ModifyAvailableSingleitemResponse modifyAvailableSingleitems(
      ModifyAvailableSingleitemsRequest request) {
    String requestPath =
        "https://api.mch.weixin.qq.com/v3/marketing/favor/stocks/{stock_id}/modify-goods-id";

    ModifyAvailableSingleitemsRequest realRequest = request;
    // 添加 path param
    requestPath = requestPath.replace("{" + "stock_id" + "}", urlEncode(realRequest.getStockId()));
    ...
    HttpRequest httpRequest =
        new HttpRequest.Builder()
            ...
            .body(createRequestBody(realRequest))
            .build();
    HttpResponse<ModifyAvailableSingleitemResponse> httpResponse =
        httpClient.execute(httpRequest, ModifyAvailableSingleitemResponse.class);
    return httpResponse.getServiceResponse();
  }
  /**
   * 修改批次预算金额
   *
   * @param request 请求参数
   * @return ModifyStockBudgetResponse
   * @throws HttpException 发送HTTP请求失败。例如构建请求参数失败、发送请求失败、I/O错误等。包含请求信息。
   * @throws ValidationException 发送HTTP请求成功，验证微信支付返回签名失败。
   * @throws ServiceException 发送HTTP请求成功，服务返回异常。例如返回状态码小于200或大于等于300。
   * @throws MalformedMessageException 服务返回成功，content-type不为application/json、解析返回体失败。
   */
  public ModifyStockBudgetResponse modifyBudget(ModifyBudgetRequest request) {
    String requestPath =
        "https://api.mch.weixin.qq.com/v3/marketing/favor/stocks/{stock_id}/max-amount-modify";
    ...
    HttpRequest httpRequest =
        new HttpRequest.Builder()
            ...
            .body(createRequestBody(realRequest))
            .build();
    HttpResponse<ModifyStockBudgetResponse> httpResponse =
        httpClient.execute(httpRequest, ModifyStockBudgetResponse.class);
    return httpResponse.getServiceResponse();
  }
  /**
   * 修改批次基本信息
   ...
   * @throws MalformedMessageException 服务返回成功，content-type不为application/json、解析返回体失败。
   */
  public ModifyStockResponse modifyStock(ModifyStockRequest request) {
    String requestPath = "https://api.mch.weixin.qq.com/v3/marketing/favor/stocks/{stock_id}";

    ModifyStockRequest realRequest = request;
    // 添加 path param
    requestPath = requestPath.replace("{" + "stock_id" + "}", urlEncode(realRequest.getStockId()));
    ...
    HttpRequest httpRequest =
        new HttpRequest.Builder()
            ...
            .body(createRequestBody(realRequest))
            .build();
    HttpResponse<ModifyStockResponse> httpResponse =
        httpClient.execute(httpRequest, ModifyStockResponse.class);
    return httpResponse.getServiceResponse();
  }
  /**
   * 暂停批次
   ...
   *
   * @param request 请求参数
   * @return StockDownloadRefundFlowResponse
   * @throws HttpException 发送HTTP请求失败。例如构建请求参数失败、发送请求失败、I/O错误等。包含请求信息。
   * @throws ValidationException 发送HTTP请求成功，验证微信支付返回签名失败。
   * @throws ServiceException 发送HTTP请求成功，服务返回异常。例如返回状态码小于200或大于等于300。
   * @throws MalformedMessageException 服务返回成功，content-type不为application/json、解析返回体失败。
   */
  public StockDownloadRefundFlowResponse refundFlow(RefundFlowRequest request) {
    String requestPath =
    ...
    HttpRequest httpRequest =
        new HttpRequest.Builder()
            ...
            .headers(headers)
            .build();
    HttpResponse<StockDownloadRefundFlowResponse> httpResponse =
        httpClient.execute(httpRequest, StockDownloadRefundFlowResponse.class);
    return httpResponse.getServiceResponse();
  }
  /**
   * 重启批次
   ...
   *
   * @param request 请求参数
   * @return StockDownloadUseFlowResponse
   * @throws HttpException 发送HTTP请求失败。例如构建请求参数失败、发送请求失败、I/O错误等。包含请求信息。
   * @throws ValidationException 发送HTTP请求成功，验证微信支付返回签名失败。
   * @throws ServiceException 发送HTTP请求成功，服务返回异常。例如返回状态码小于200或大于等于300。
   * @throws MalformedMessageException 服务返回成功，content-type不为application/json、解析返回体失败。
   */
  public StockDownloadUseFlowResponse useFlow(UseFlowRequest request) {
    String requestPath =
    ...
    HttpRequest httpRequest =
        new HttpRequest.Builder()
            ...
            .headers(headers)
            .build();
    HttpResponse<StockDownloadUseFlowResponse> httpResponse =
        httpClient.execute(httpRequest, StockDownloadUseFlowResponse.class);
    return httpResponse.getServiceResponse();
  }
