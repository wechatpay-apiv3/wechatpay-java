...
public interface BaseSM2Test {
    ...
    String CIPHERTEXT = "MHECIAGn23Ew8nF0zRfu3qgdD6VATSmGM5wrVFvNqg1ToXneAiBgfOJLVi1NtpRVH2"
                    + "qanzooL4gOrDKKOloD7gS17g+iCQQgcTtJpGhytHZeV/HeTqYkg3YqOY+Vybx+OQx217Ktn0QECdMjiI7lpId5dg==";
    String PLAINTEXT = "plaintext";

    String MESSAGE = "message";
    String SIGN = "MEYCIQD35Rp3CKt7pLme/a0GaCVmwSeOl7X/12+ppRivcJuf6QIhAO5Vpy4tSk9SJUrgH5I5Qy0aYhFG9lN0aof1f5wJOI05";
    ...
    default void testDecryptFail() {
        ...
        assertThrows(
                DecryptionException.class, () -> d.decrypt(ciphertext));
    }
