...
![Maven Central](https://img.shields.io/maven-central/v/com.github.wechatpay-apiv3/wechatpay-java?versionPrefix=0.2.9)
...
```groovy
implementation 'com.github.wechatpay-apiv3:wechatpay-java:0.2.9'
```
