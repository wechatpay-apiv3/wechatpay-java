...
public static void main(String[] args) {
    ...
    //         .build();
    // HttpClient okHttpClientAdapter = new OkHttpClientAdapter(config.createCredential(), config.createValidator(),
    //         okHttpClient);
    // service = new MarketingBankPackagesServiceExtension.Builder().config(config).httpClient(okHttpClientAdapter)
    //         .build();
