...
public class TestConfig {
  ...
  static {
    try {
      ...
      MERCHANT_CERTIFICATE = SMPemUtil.loadX509FromString(MERCHANT_CERTIFICATE_STRING);
      WECHAT_PAY_CERTIFICATE_STRING = IOUtil.loadStringFromPath(WECHAT_PAY_CERTIFICATE_PATH);
      WECHAT_PAY_CERTIFICATE = SMPemUtil.loadX509FromString(WECHAT_PAY_CERTIFICATE_STRING);
