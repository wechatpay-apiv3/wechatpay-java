...
public class SMPemUtil {
   ...
   * @return X509证书
   */
  public static X509Certificate loadCertificateFromPath(String certificatePath) {
   ...
   * @return X509证书
   */
  public static X509Certificate loadCertificateFromString(String certificateString) {
