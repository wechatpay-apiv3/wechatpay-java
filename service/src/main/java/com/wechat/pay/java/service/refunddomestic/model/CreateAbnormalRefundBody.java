...
public class CreateAbnormalRefundBody {
  ...
  public String toString() {
    ...
    sb.append("class CreateAbnormalRefundBody {\n");
  ...
  public CreateAbnormalRefundBody cloneWithCipher(UnaryOperator<String> s) {
    CreateAbnormalRefundBody copy = new CreateAbnormalRefundBody();
